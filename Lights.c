...
void inicializaSol() {
    ...
    GLfloat light_position[] = { 2.0f, 300.0f, 5.0f, 1.0f };
...
void inicializaLuzesInternas(){
    ...
    GLfloat light_position_1[] = { 97.0f, lights_height_intern, 97.0, 0.0f };
    ...
    GLfloat light_position_2[] = { 309.0f, lights_height_intern, 97.0f, 0.0f };
    ...
    GLfloat light_position_3[] = { 521.0f, lights_height_intern, 97.0f, 0.0f };
    ...
    GLfloat light_position_4[] = { 733.0f, lights_height_intern, 97.0f, 0.0f };
